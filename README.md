...
* Clemente C, Chambel G, Silva DCF, Montes AM, Pinto JF,  Pinto, Silva HP, Feasibility of 3D Body Tracking from Monocular 2D Video Feeds in Musculoskeletal Telerehabilitation, 2023, [https://github.com/carolinaclemente00/3D-HPE-MediaPipe-Pose.git](https://github.com/carolinaclemente00/3D-HPE-MediaPipe-Pose.git) [Online; accessed <year>-<month>-<day>].
```
@Misc{,
